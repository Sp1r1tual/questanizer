...
import NavbarAuthBtn from "../../navbar/NavbarAuthBtn";
...
describe("NavbarAuthBtn", () => {
    ...
    describe("when user is not authenticated", () => {
        ...
        it("displays login image", () => {
            ...
            expect(authImage).toHaveAttribute(
                "src",
                "user-authentication-svgrepo-login.png"
            );
        });
    ...
    describe("when user is authenticated", () => {
        ...
        it("displays logged in image", () => {
            ...
            expect(authImage).toHaveAttribute(
                "src",
                "user-authentication-svgrepo-logged-in.png"
            );
        });
