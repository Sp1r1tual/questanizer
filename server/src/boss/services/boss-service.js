...
class BossService {
    async getBoss(userId) {
        try {
            ...
            console.error("Error in getBoss:", error);
            throw error;
        }
    }
        ...
        try {
            ...
            if (!config) {
                return {
                    boss: null,
                    messages: [
                        success("You have defeated all available bosses!"),
                    ],
    ...
    async damageBoss(userId, amount) {
        try {
            ...
            if (isDead) {
                await userStatsService.gainExperience(
                    userId,
                    boss.bossRewardExp
                );
            ...
            console.error("Error in damageBoss:", error);
            throw error;
        }
    }
    ...
    async addRage(userId, newTaskIds = []) {
        try {
            ...
            console.error("Error in addRage:", error);
            throw error;
        }
    }
    ...
    async markTaskAsRaged(userId, taskId) {
        try {
            ...
            console.error("Error in markTaskAsRaged:", error);
            throw error;
        }
    }
    ...
    async resetBoss(userId) {
        try {
            ...
            console.error("Error in resetBoss:", error);
            throw error;
        }
    }
}
